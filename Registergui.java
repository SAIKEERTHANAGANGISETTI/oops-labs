...
if(nameT.getText().toString().isEmpty()||emailT.getText().toString().isEmpty()||mobileT.get
Text().toString().isEmpty()||regnoT.getText().toString().isEmpty()||branch.getSelectedItem(
).toString().isEmpty()){
